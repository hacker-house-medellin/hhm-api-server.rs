#![forbid(unsafe_code)]
//! Serving the four avenues from `hhm-api`.
//!
...
//! |---|------|---------------------|
//! | 1 | `direct_read` | none: the web server reads Postgres itself through `hhm-lib-core` |
...
///
/// Bind `HHM_API_MTLS_ADDR` and pass the listener. One task per
...
/// Open the JetStream context for avenue 4 from `HHM_NATS_URL`.
///
/// # Errors
